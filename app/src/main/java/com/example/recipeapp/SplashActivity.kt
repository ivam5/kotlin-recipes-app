...
class SplashActivity : BaseActivity(), EasyPermissions.RationaleCallbacks, EasyPermissions.PermissionCallbacks {
    ...
    fun getCategories(){
        ...
        call.enqueue(object : Callback<Category>{
            ...
            override fun onFailure(call: Call<Category>, t: Throwable) {
                Toast.makeText(this@SplashActivity,getString(R.string.sth_went_wrong), Toast.LENGTH_SHORT).show()
            }
        })
        }
    ...
    override fun onPermissionsDenied(requestCode: Int, perms: MutableList<String>) {
       if (EasyPermissions.somePermissionPermanentlyDenied(this, perms)) {
           AppSettingsDialog.Builder(this).build().show() //ako ova funkcija vrati true to znači da korisnik nije odobrio permissione i onda mu se ponovo pokazuje
       }                                                            //dialog gdje moze oznaciti za permissione
    }
